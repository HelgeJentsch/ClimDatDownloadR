...
Jentsch, Helge, Weidinger, Johannes, & Bobrowski, Maria. (_current year e.g. 2023_). ClimDatDownloadR: Downloads Climate Data from Chelsa and WorldClim (\_current version e.g. 1.0.0). Zenodo. DOI: [10.5281/zenodo.15663182](https://doi.org/10.5281/zenodo.15663182). URL: <https://github.com/HelgeJentsch/ClimDatDownloadR>.
